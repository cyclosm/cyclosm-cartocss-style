...
CREATE VIEW cyclosm_amenities_point AS
    SELECT
        ...
        WHERE aeroway IN ('helipad', 'aerodrome')
          ...
          OR amenity IN ('atm', 'bank', 'bar', 'bench', 'bicycle_rental', 'bicycle_parking', 'bicycle_repair_station', 'bicycle_wash',
