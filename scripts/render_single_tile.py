...
# found there https://raw.githubusercontent.com/giggls/openstreetmap-carto-de/master/scripts/render_single_tile.py
# just change time from decimal to float
...
if __name__ == "__main__":
  ...
  if args.time:
    ...
    print("rendering time: %f seconds" % (end - start))
