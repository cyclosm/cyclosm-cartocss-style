...
OSM2PGSQL_TAGS = [
    ...
    'construction text', 'covered', 'culvert', 'cutting', 'denomination text',
    'disused', 'ele', 'embankment', 'foot', 'generator:source', 'harbour',
    'highway', 'historic', 'horse', 'intermittent text', 'junction',
    'landuse', 'layer', 'leisure', 'lock', 'man_made', 'military', 'motorcar',
    'name', 'natural', 'office', 'oneway', 'operator', 'place', 'population',
    'power', 'power_source text', 'public_transport text', 'railway', 'ref',
