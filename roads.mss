...
@rdz11_maj: 1.6; @rdz11_med: 0.8; @rdz11_min: 0.3;
@rdz12_maj: 2.5; @rdz12_med: 1.2; @rdz12_min: 0.55;
@rdz13_maj: 3;   @rdz13_med: 1.5; @rdz13_min: 0.8;
@rdz14_maj: 4;   @rdz14_med: 2.8; @rdz14_min: 1;
@rdz15_maj: 6;   @rdz15_med: 4;   @rdz15_min: 1.5;
@rdz16_maj: 12;  @rdz16_med: 8;   @rdz16_min: 4;
@rdz17_maj: 20;  @rdz17_med: 15;  @rdz17_min: 10;
@rdz18_maj: 26;  @rdz18_med: 20;  @rdz18_min: 14;
...
#roads_high::outline_right[zoom>=11][zoom<=20][cycleway_right='opposite_share_busway'] {
  ...
  [zoom=13] {
    ...
    [stylegroup='minorroad']{ line-width: @rdz13_min + 0; line-offset: 1; }
    /* No minor bridges yet */
    [stylegroup='service']  { line-width: 0; }
    [stylegroup='pedestrian']   { line-width: 0; }
    [stylegroup='cycle']   { line-width: 0; }
  ...
  [zoom=14] {
    ...
    [stylegroup='minorroad']{ line-width: @rdz14_min + 0; line-offset: 1; }
    /* No minor bridges yet */
    [stylegroup='service']  { line-width: 0; }
    [stylegroup='pedestrian']   { line-width: 0; }
    [stylegroup='cycle']   { line-width: 0; }
...
#bridge[render='3_inline'][zoom>=11][zoom<=20]{
  ...
  [zoom=13] {
    ...
    [stylegroup='pedestrian']   { line-width: @rdz13_min / 3; line-dasharray: 1,1; }
    [stylegroup='cycle']   { line-width: @rdz13_min; }
  ...
  [zoom=14] {
    ...
    [stylegroup='pedestrian']   { line-width: @rdz14_min / 3; line-dasharray: 1,1; }
    [stylegroup='cycle']   { line-width: @rdz14_min / 1.5; }
  ...
  [zoom=15] {
    ...
    [stylegroup='cycle']   { line-width: @rdz15_min / 2; }
...
#bridge[render='2_line'][zoom>=14][zoom<=20]{
  ...
  /* -- widths -- */
  [zoom=14] {
    [stylegroup='pedestrian']   { line-width: @rdz14_min / 3 + 1; }
    [stylegroup='cycle']   { line-width: @rdz14_min / 2 + 1; }
    [stylegroup='railway']  { line-width: 1 + 1; }
  }
  [zoom=15] {
    [stylegroup='pedestrian']   { line-width: @rdz15_min / 4 + 1; }
    [stylegroup='cycle']   { line-width: @rdz15_min / 2 + 1; }
